...
export default function GlobalSearch({ onNavigate }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {/* Results Dropdown */}
      {open && query && loaded && (
        <div className="absolute top-full right-0 mt-2 w-[520px] rounded-[1rem] border border-brand-border bg-brand-black/95 backdrop-blur-md shadow-2xl z-50 overflow-hidden">
          {!hasResults ? (
